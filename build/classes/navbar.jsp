            ...
            <ul class="top_row flex-row">
                <li>
                    <a href="index.jsp" class="navlinks">
                        <img src="assets/images/icons/home.png" alt="Home"><span class="hidden-sm-down">Home</span>
                    </a>
                </li>
                <li>
                    <a href="schemes.jsp" class="navlinks">
                        <img class="scheme" src="assets/images/icons/scheme.png" alt="Schemes"><span class="hidden-sm-down">Schemes</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="contact.jsp" class="navlinks">
                        <img src="assets/images/icons/contact.png" alt="Contact"><span class="hidden-sm-down">Contact Us</span>
                    </a>
                </li>
                <li>
                    <a href="faqs.jsp" class="navlinks">
                        <img src="assets/images/icons/help.png" alt="Help"><span class="hidden-sm-down">FAQs/Help</span>
                    </a>
                </li>
                <li>
    ...
    <div class="container-fluid clearfix">
        <div class="d-flex justify-content-between">
            <div class="logo" style="width: 400px">
                <a href="/index.html"><img src="assets/images/logo/logo.png" alt="People's Voice Logo" width="400px"></a>
            </div>
